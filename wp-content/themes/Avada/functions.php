...
function load_scripts() {
    if( is_front_page() )
    {
        wp_enqueue_script('search_engine', get_template_directory_uri() . '/assets/js/custom/search_engine.js');
    } 
}
...
function theme_styles() {
	...
	wp_enqueue_style( 'main_css', get_template_directory_uri() . '/assets/css/custom/style.css',array(), '1.0' );
