	...
	function avada_main_menu( $flyout_menu = false ) {
		...
		if ( $flyout_menu ) {
			...
			if (is_front_page()) {
				echo '
					<ul class="list-group">
						<li class="list-group-item">Sourcing and Suppliers</li>	
						<li class="list-group-item">Keywords</li>	
						<li class="list-group-item">ERP Tools</li>	
						<li class="list-group-item">Collect Payment</li>	

						<ul>
							<li><i class="fa fa-qrcode"></i></li>
							<li><i class="fa fa-weixin"></i></li>
							<li><a href="/test/community/?wpforo=signin"><i class="fa fa-sign-in"></i></a></li>
						</ul>
					</ul>
				';
			} else {
