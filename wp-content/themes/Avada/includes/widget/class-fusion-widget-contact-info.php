...
class Fusion_Widget_Contact_Info extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="contact-info-container">
			...
			<?php if ( isset( $instance['email2'] ) && $instance['email2'] ) : ?>
				<p class="email2"><?php esc_attr_e( 'Email:', 'Avada' ); ?> <a href="mailto:<?php echo wp_kses_post( antispambot( $instance['email2'] ) ); ?>"><?php echo ( wp_kses_post( $instance['emailtxt'] ) ) ? wp_kses_post( $instance['emailtxt'] ) : wp_kses_post( $instance['email2'] ); ?></a></p>
			<?php endif; ?>
	...
	public function form( $instance ) {
		...
		<p>
			...
			<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'email2' ) ); ?>" value="<?php echo esc_attr( $instance['email2'] ); ?>" />
		</p>
		<p>
